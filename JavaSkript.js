...
// let yop = "MARS IT SCHOOL"
// for (let index = 0; index < yop.length; index++) {
//     const element = yop[index];
//     console.log(yop);
...
//let harev = ["a" , "b" , "d" , "e" , "f" , "g" , "h" , "i" , "j" , "k" , "l" , "m" , "n" , "o" , "p" , "q" , "r" , "s" , "t",  "u" , "v" , "x" , "y" , "z" ]
...
//console.log(harev[0] + harev[11] + harev[7] + harev[16] + harev[6] + harev[13] + harev[12] )
...
// let yosh = prompt('yoshingizni kiriting')
 //if (yosh>18) {
 //   alert('bemalol kiring')
 //} else {
 //    alert('ey kichkkintoy uyga bor')
 //}
...
//console.log(harev[12] + harev[13] + harev[6] + harev[16] + harev[7] + harev[11] + harev[0] )
...
//let juft_arr = [2,4,6,8,10,]
//let toq_arr = [1,3,5,7,9,]
